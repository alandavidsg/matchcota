  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="bg-[#1a1a2e] px-8 py-20 text-center">
        <h1 className="text-white text-4xl font-semibold mb-4">Quiénes somos</h1>
      ...
      <section className="max-w-3xl mx-auto px-8 py-16">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 mb-6">
          <h2 className="text-xl font-semibold text-[#1a1a2e] mb-4">Cómo funciona</h2>
          <div className="flex flex-col gap-4">
            {[
              { num: '01', title: 'Reporta', desc: 'Saca una foto de una mascota en la calle. La IA detecta automáticamente su especie, raza y edad.' },
              { num: '02', title: 'Se publica', desc: 'La mascota aparece en el catálogo con su ubicación exacta para que otros puedan verla.' },
